    ...
    <div>
        ...
        <div class="member">
            <ul class="chat-dialogue-entry-collect">
                <li v-for="item in $route.query.msgInfo.user" :key="item.wxid">
                    <!-- 显示对话人的头像，点击 这个头像会进入个人详情页-->
                    <div><router-link :to="{path:'/contact/details',query:{wxid:item.wxid}}"><img :src="item.headerUrl"></router-link></div>
        ...
        <div class="weui-cells">
            ...
            <div class="weui-cell weui-cell_access">
                <div class="weui-cell__bd">查找聊天记录</div>
                <div class="weui-cell__ft"></div>
            </div>
        </div>
        <div class="weui-cells">
